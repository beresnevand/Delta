...
#define EXT0_STEPS_PER_MM 518 //385 413
...
#define X_MAX_LENGTH 322.5 //#define X_MAX_LENGTH 166
#define Y_MAX_LENGTH 322.5 //#define Y_MAX_LENGTH 166
//#define Z_MAX_LENGTH 171.5 //#define Z_MAX_LENGTH 166
#define Z_MAX_LENGTH 322.5 // with clamps and kapton tape
...
/** \brief Delta rod length
  Printing something 100mm long results in a printed object that is not exactly 100 mm long. 
This also, can be corrected in firmware.  Adjustments to DELTA_DIAGONAL_ROD in the firmware control the size of the printed object.
 If the length of 100mm object is wrong, adjust DELTA_DIAGONAL_ROD:
new DELTA_DIAGONAL_ROD = 100 / measured_length * original DELTA_DIAGONAL_ROD
*/
//#define DELTA_DIAGONAL_ROD  184 // 345 mm
//#define DELTA_DIAGONAL_ROD  195.15
//#define DELTA_DIAGONAL_ROD  185.5
#define DELTA_DIAGONAL_ROD  185
...
// the radius of the bed circular plexi glass
...
#define UI_PRINTER_NAME "DeltaFactory"
#define UI_PRINTER_COMPANY "Our-Factory.Com"
